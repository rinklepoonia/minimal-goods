...
const Footer = () => {
    ...
    return (
        <div id='footer' className="bg-[#2E2A27]  border-t border-solid border-gradient z-[2] relative rounded-b-[60px]">
                ...
                <div className="flex lg:flex-row flex-col justify-between gap-7">
                    ...
                    <div className='lg:w-[60%] flex flex-wrap xl:gap-[109px] sm:gap-[63px] gap-10  lg:justify-end justify-between'>
                        {FOOTER_DATA_LIST.map((obj, i) => (
                            <div key={i}>
                                <h4 className="font-bold text-lg leading-[160%] text-white sm:mb-4 mb-2">{obj.title}</h4>
