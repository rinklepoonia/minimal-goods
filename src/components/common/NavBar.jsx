                    ...
                    <div className='flex items-center justify-between h-[85px] border-b border-solid border-white'>
                        <ul className='flex items-center gap-3 '>
                            {NAV_DATA_LIST.map((obj, i) => (
                                <li key={i}>
                                    <Link href={obj.href} className="text-white hover:text-blue-500 transition-colors duration-300 text-base font-bold">
                                        {obj.title}
                                    </Link>
                                </li>
                            ))}
                        ...
                        <p className='text-sm text-white font-medium text-nowrap'>(2021), All rights reserved</p>
                    </div>
                </div>
            </div>
        </div>
