...
const NavBar = () => {
    useLayoutEffect(() => {
        let ctx = gsap.context(() => {
            ...
            mm.add("(min-width: 769px) and (max-width: 1299px)", () => {
                tl.from("#logoAnimate", {
                    y: -100,
                    scale: 5
                });
