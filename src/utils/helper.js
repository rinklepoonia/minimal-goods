...
export const FURNITURE_IMAGES_DATA_LIST = [
    ...
    [
        { src: "/assets/images/webp/library-bulb.webp", width: 420, height: 551, className: "xl:w-[26%] w-[20%] mr-[6.25%] mt-[-13%]", imageHeight: "xl:h-[551px]", alt: "library-bulb" },
        { src: "/assets/images/webp/green-plant.webp", width: 334, height: 438, className: "w-[25%] xl:mr-[25%] mr-[15%] mt-[-8%]", imageHeight: "xl:h-[438px]", alt: "green-plant" },
    ],
    [
    ...
    [
        { src: "/assets/images/webp/cycle.webp", width: 420, height: 551, className: "w-[26%] mr-[6.25%] mt-[-13%]", imageHeight: "xl:h-[551px]", alt: "cycle" },
        { src: "/assets/images/webp/bony.webp", width: 334, height: 438, className: "w-[25%] mr-5 mt-[-8%]", imageHeight: "xl:h-[438px]", alt: "bony" },
    ],
];